...
Constants = ["betIncrement", "timerDefault", "timerIncrement", "ineByLowShareOfPot", "ineByTopShareOfPot", "timerStepDecrementByBets", "timerStepDecrementByAmount", "randomLimitBot", "randomLimitTop", "houseFee", "winningsDestribution"]
Constants.push("userCredits") //online ppl is here
Defaults = [1, 5, 3, .1, .1, 10, 0.5, 3, 30, .02, .2]
Defaults.push(10)
